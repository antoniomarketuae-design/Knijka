...
const configs = [
  { name: "land_tab", width: 844, height: 390, standalone: false },
  { name: "land_standalone", width: 844, height: 390, standalone: true },
  { name: "port_tab", width: 390, height: 844, standalone: false },
  { name: "port_standalone", width: 390, height: 844, standalone: true },
];
const results = [];
