...
- **Options considered:** (a) grind the remainder in one undifferentiated push; (b) stage the subsystems by unlocked-archetype-weight per effort (doc 72 §15 ranked list), each behind its own gate; (c) stop at 50 and rely on the 14,940-exam bank for breadth.
