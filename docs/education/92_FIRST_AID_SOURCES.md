...
>
> ⚠️ **`node tools/theory/gen_first_aid_sources.mjs` ПРЕЗАПИСВА този файл и свършва на §7.3.**
> Регенерация ИЗТРИВА §8, §9 и §10 — цялата история на вратите. Запази опашката от §8 нататък и я върни.
...
⚠️ **`tools/theory/gen_first_aid_sources.mjs` ПРЕЗАПИСВА целия файл** и свършва на §7.3. Регенерация
изтрива §8, §9 и §10 — цялата история на вратите. Преди `node tools/theory/gen_first_aid_sources.mjs`:
запази опашката от §8 нататък и я върни обратно.
