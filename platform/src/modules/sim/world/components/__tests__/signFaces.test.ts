 ...
 *  3. the ten shipped faces still satisfy the preconditions the swap demands;
...
// ---------------------------------------------------------------------------
// 3. The ten shipped faces still satisfy what the swap demands
// ---------------------------------------------------------------------------
