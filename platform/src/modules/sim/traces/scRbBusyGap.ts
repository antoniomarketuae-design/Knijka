  ...
  return {
    steps: [
      ...
      { kind: "pause", sec: 2.5, brake: true },
      {
        kind: "annotation",
        textBg:
          "Влизащият НЯМА предимство: чл. 50а изисква да пропуснеш всички, които вече се движат в кръга — дори с цената на пълно спиране на входа.",
      },
    ],
  };
}
  ...
  return {
    steps: [
      ...
      { kind: "pause", sec: 1.2, brake: true },
      {
        kind: "annotation",
        textBg:
          "„Пропусни движещите се в кръга“ не значи „изчакай една кола“. Влизаш само когато никой в кръга не трябва да намалява заради теб (чл. 50а).",
      },
    ],
  };
}
