  ...
  return {
    steps: [
      ...
      { kind: "pause", sec: 2.5, brake: true },
      {
        kind: "annotation",
        textBg:
          "Влизащият НЯМА предимство: на входа стои Б1/Б2 (Наредба № РД-02-21-1/23.11.2023, чл. 61, ал. 5), значи пропускаш вече движещите се в кръга (ЗДвП чл. 50, ал. 1). „Пропусни“ не значи „чакай празен кръг“ — значи „не карай никого в кръга да намалява“.",
      },
    ],
  };
}
