  ...
  return {
    steps: [
      ...
      { kind: "pause", sec: 1.5, brake: true },
      {
        kind: "annotation",
        textBg:
          "Кръговото не е „стоп“. Влиза се с преценка, не с паника — а вътре предимството вече е твое: чакащият на входа е този с Б1/Б2 и той пропуска теб (ЗДвП чл. 50, ал. 1).",
      },
    ],
  };
}
