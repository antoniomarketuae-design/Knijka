...
export const SC_MERGE_ACCEL_LANE: ScenarioSpec = {
  ...
  instructionsBg: [
    ...
    // One line shorter, nothing lost: on a 780×360 Android landscape phone the
    // open sheet dropped «лента — там не се кара.», the hard-shoulder warning
    // (sc-merge-accel-lane:b75b356e, tools/mobile/sheet-fold.mjs).
    { n: 6, textBg: "Изключи мигача и карай в дясната лента. След лентата за ускоряване е аварийната — там не се кара." },
  ],
  success: [
    {
      id: "sc-mrg-accel",
