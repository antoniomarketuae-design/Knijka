 ...
 * (laneId 0), cruise x = 0 (laneId 1), limit 140. The чл. 58, т. 4 detector
 ...
 * т. 4: „да се движи… в лентата за принудително спиране" — забранено без
 * изключение; чл. 58, т. 3: спирането в нея е позволено „при повреда на
 * пътното превозно средство, както и при здравословни проблеми на водача или
 * пътниците" — двете точки са различни и сцената грaдира първата; чл. 97:
 * задълженията при повреда — извеждане на
 ...
 *     travel in laneId 0 grades EXACTLY EMERGENCY_LANE_DRIVING (чл. 58, т. 4 —
...
export const SC_HZ_BREAKDOWN_PULLOFF: ScenarioSpec = {
  ...
  teach: {
    ...
    lawRef: "ЗДвП чл. 58, т. 4; чл. 58, т. 3",
    examinerBg:
