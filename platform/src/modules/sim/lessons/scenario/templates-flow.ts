...
export const SC_ROUNDABOUT_ENTRY: ScenarioSpec = {
  ...
  mistakes: [
    {
      ...
      whatWentWrongBg:
        "Колата навлезе в кръга с непроменена скорост точно пред движещия се в него автомобил. Влизащият НЯМА предимство, и причината стои на самия вход: знакът „Път с предимство“ Б3 не може да се поставя на входовете на кръгово кръстовище (Наредба № РД-02-21-1/23.11.2023, чл. 61, ал. 5), затова там винаги стои Б1 или Б2 и ти си на пътя без предимство. А на кръстовище, на което единият път е сигнализиран като път с предимство, водачите от другите пътища са длъжни да пропуснат движещите се по него (ЗДвП чл. 50, ал. 1) — дори това да значи пълно спиране на входа.",
  ...
  teach: {
    ...
    whyBg:
      "Предимството в кръга не идва от отделен член „за кръговите“ — такъв в ЗДвП няма. Идва от знака на входа: Б3 „Път с предимство“ не може да се поставя на входовете на кръгово кръстовище (Наредба № РД-02-21-1/23.11.2023, чл. 61, ал. 5), затова там стои Б1 или Б2, ти си на пътя без предимство и пропускаш движещите се в кръга (ЗДвП чл. 50, ал. 1). Това е и цялата безопасност на кръговото: то е по-безопасно от обикновеното кръстовище само докато редът на пропускане се спазва — влизане „на инат“ пред кола в кръга е сред най-честите причини за странични удари. А мигачът на изхода (чл. 28, ал. 1, т. 2) е това, което позволява на чакащите по входовете изобщо да потеглят.",
