...
export const SC_ANIMAL_HAZARD: ScenarioSpec = {
  ...
  teach: {
    ...
    whyBg:
      "Отбиването в насрещното сменя дребен удар с челен сблъсък. Непрекъснатата осева линия М1 пази точно този сценарий: „На пътните превозни средства е забранено да я застъпват и пресичат“ (ППЗДвП чл. 63, ал. 2, т. 1) — а при възникнала опасност чл. 20, ал. 2 иска незабавно намаляване и при нужда аварийно спиране, „като не извършват маневри, с които могат да застрашат своя живот или здраве, живота или здравето на други лица“. Спира се право.",
    ...
    lawRef: "ППЗДвП чл. 63, ал. 2, т. 1; ЗДвП чл. 20, ал. 2",
