...
export const SC_VU_BLINDSPOT_MOTO: ScenarioSpec = {
  ...
  instructionsBg: [
    ...
    { n: 6, textBg: "Влез плавно в лявата лента, изключи мигача и продължи." },
    {
      n: 7,
      textBg:
        "Вали ли (ниво 5), карай с включени къси светлини през цялото упражнение: мокрото платно и пръските правят тесния мотор почти невидим в огледалото, а твоите светлини са това, по което той преценява теб.",
    },
  ],
  success: [
    {
...
export const SC_VU_CYCLIST_GROUP: ScenarioSpec = {
  ...
  instructionsBg: [
    ...
    },
    {
      n: 7,
      textBg:
        "Вали ли (ниво 5), включи късите светлини преди да потеглиш и разшири разминаването: мокрият асфалт удължава спирачния път с около 40%, а велосипедистът в дъжда се плъзга и лъкатуши повече, отколкото в сухо.",
    },
  ],
  success: [
    {
...
/**
 * VU-01, the TWO-WAY / counter-flow variant — десен завой през велоалея.
 *
 * CITATION CORRECTED 2026-08-03: this cited „чл. 25, ал. 2, т. 3". чл. 25,
 * ал. 2 has no numbered points at all — it is two sentences. Retrieved:
 *   чл. 25, ал. 2: „При извършване на маневра, която е свързана с навлизане
 ...
 *   чл. 5, ал. 2, т. 1: „да бъде внимателен и предпазлив към уязвимите
 *     участници в движението… и водачите на двуколесни пътни превозни средства".
 * (чл. 42 stays for the side-clearance half: ал. 2, т. 1 „да осигури достатъчно
 * странично разстояние".) Bank-verified: q-predimstvo-062 grounds the right-turn-across-
...
export const SC_VU_BIKELANE_TURN: ScenarioSpec = {
  ...
  instructionsBg: [
    ...
    { n: 6, textBg: "Влез плавно в страничната улица, изключи мигача и продължи." },
    {
      n: 7,
      textBg:
        "Вали ли (ниво 5), карай с включени къси светлини: велосипедистът по мократа алея е тъмен силует без светлоотразител, а твоите светлини са това, което му казва, че си там и че завиваш.",
    },
  ],
  success: [
    {
  ...
  teach: {
    ...
    lawRef: "ЗДвП чл. 25, ал. 2; чл. 35, ал. 2; чл. 42, ал. 2, т. 1; чл. 5, ал. 2, т. 1",
    examinerBg:
