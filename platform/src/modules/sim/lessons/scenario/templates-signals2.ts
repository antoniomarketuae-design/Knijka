...
export const SC_SIG_CONTROLLER_POSTURES: ScenarioSpec = {
  ...
  instructionsBg: [
    ...
    },
    {
      n: 5,
      textBg:
        "Щом се обърне със СТРАНИЧЕН ПРОФИЛ и отпусне ръце, посоката ти е отворена, напречната е спряна и предимството е твое — премини решително и спокойно на север (ППЗДвП чл. 29, ал. 3).",
    },
  ],
  success: [
    {
