...
export const N38_BASIS: Record<ViolationCode, N38Basis> = {
  ...
  POLICE_STOP_SIGNAL_IGNORED: {
    clause: "а",
    rationaleBg:
      "Спирането по сигнал на контролен орган е изрично задължение към водача, което се учи в първите часове: ЗДвП чл. 103 казва „длъжен е да спре плавно в най-дясната част на платното за движение“. Подминаването е неправилно действие от липса на знания и умения по б. „а“ — а не някой от шестте изброени случая по б. „в“: униформен служител със стоп-палка на тротоара не е „регулировчик“ по случай 1 (там се урежда кръстовище, чиито посоки той разпределя), а само по себе си подминаването не установява нито превишена скорост, нито предпоставка за ПТП. Стигне ли до удар, деянието вече е COLLISION и се таксува там.",
  },
