...
export const N38_BASIS: Record<ViolationCode, N38Basis> = {
  ...
  POLICE_STOP_SIGNAL_IGNORED: {
    clause: "а",
    rationaleBg:
      "Спирането по сигнал на контролен орган е изрично задължение към водача, което се учи в първите часове: по ЗДвП чл. 103 водачът „е длъжен да спре плавно в най-дясната част на платното за движение“. Подминаването е неправилно действие от липса на знания и умения по б. „а“ — а не някой от шестте изброени случая по б. „в“: униформен служител със стоп-палка на тротоара не е „регулировчик“ по случай 1 (там се урежда кръстовище, чиито посоки той разпределя), а само по себе си подминаването не установява нито превишена скорост, нито предпоставка за ПТП. Стигне ли до удар, деянието вече е COLLISION и се таксува там.",
  },
  WARNING_LAMP_IGNORED: {
    clause: "а",
    rationaleBg:
      "Червената контролна лампа е предписание към водача, което се учи в първите часове: ЗДвП чл. 101, ал. 1 казва „длъжен е да спре“. Продължаването нататък е неправилно действие от липса на знания и умения по б. „а“ — а не някой от шестте изброени случая по б. „в“: светнала лампа сама по себе си не е нито регулировчик, нито превишена скорост, нито установена предпоставка за ПТП. Ако повредата стигне до удар, деянието вече е COLLISION и се таксува там.",
  },
  ...
  OFF_CARRIAGEWAY: {
    clause: "а",
    rationaleBg:
      "Къде има право да бъде автомобилът е първото знание от първия час — платното за движение и границата му са дефинирани в самия закон (ЗДвП § 6, т. 3 и т. 4), а чл. 15, ал. 1 задължава водача да се движи ПО него. Излизането извън платното е неправилно действие от липса на знания и умения по б. „а“.",
    contestedBg:
      "ЗАЩО НЕ Е ДЕСЕТКА, ПРОВЕРЕНО СРЕЩУ САМИЯ АКТ, А НЕ СРЕЩУ УСЕЩАНЕТО. Б. „в“ е ЗАТВОРЕНО изброяване от шест случая (N38_OPASNA_CASES по-горе) и излизането от платното не е нито един от петте конкретни: не е сигнал на светофар или регулировчик, не е навлизане срещу движението, не е неспиране при Б2, не е намеса на комисията, не е превишаване с над 10 km/h. Остава единствено случай 5 („създаде предпоставка за допускане на ПТП“) — и точно тук се прилага прецедентът CROSSED_SOLID_LINE от 2026-08-09, защото детекторът е със СЪЩАТА форма: позиция плюс продължителност, без нито един тест за друг участник. Това е conflictEvidence „geometric“, което този файл изрично забранява на десетточков код. Три точки с основание бият десет без основание.\n\nКАКВО СЕ ГУБИ И ЗАЩО Е ПРИЕМЛИВО: тежките изходи от излизането извън платното вече си имат кодове и те носят десетката — ударът в дърво, стълб или мантинела е COLLISION (10, прекратяващ; собственият му текст казва „Излизането от платното е самото произшествие“), а причината, когато е скорост в завой, е SPEED_TOO_FAST_FOR_CURVE. Този код покрива случая, в който НИЩО от това не се е случило — колата кара или стои извън платното и се разминава без последствие, — а именно той досега не струваше нищо.\n\nВЪЗМОЖНО БЪДЕЩО ПРЕМИНАВАНЕ КЪМ Б. „в“, записано, за да не се направи мълчаливо: ако някой ден детекторът установи КОНФЛИКТ извън платното (пешеходец на тротоара, велосипедист на банкета — тела, които симулаторът вече умее да поставя), тогава случай 5 се печели по същия начин, по който го печели OVERTAKING_AT_CROSSING, и класът се вдига заедно с доказателството. Дотогава — б. „а“.",
  },
  ...
  DRIVING_TOO_SLOW_IN_TOWN: {
    clause: "б",
    rationaleBg:
      "Същото основание като на магистралния вариант, в населено място: няма нарушено числово правило, а неточна преценка на темпото на потока от неопитност — правилно, но неточно действие.",
  },
  STOPPED_WITHOUT_CAUSE: {
    clause: "б",
    rationaleBg:
      "Спирането е правилно действие, изпълнено там, където нищо не го е налагало — точно определението на б. „б“: правилно, но неточно действие от недостатъчен практически опит. Няма нарушено числово правило и няма изброен случай по б. „в“; задължението по чл. 24, ал. 2 е да се убедиш, че не затрудняваш излишно другите, а не забрана със свое наказание.",
  },
