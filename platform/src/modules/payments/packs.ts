...
export const PACKS: Record<"core" | "premium_sim", PackDefinition> = {
  ...
  premium_sim: {
    ...
    checkoutDescriptionBg:
      "Еднократно плащане · 4 месеца пълен достъп до Книжка.AI: всичко от „Пълна подготовка“ + шофьорски симулатор при пускането му.",
    priceEurCents: 2199, // 21,99 €
    accessMonths: PACK_ACCESS_MONTHS,
    featuresBg: [
      "Всичко от „Пълна подготовка“",
      "Шофьорски симулатор — достъп при пускането му",
