...
export function TheoryFocus({
  ...
  return (
    <header className="panel-glass relative isolate overflow-hidden p-4 sm:p-6">
      ...
      <div className="flex items-start gap-4">
        <div className="min-w-0 flex-1">
          ...
          <h1 className="mt-1 font-display text-[26px] font-black leading-none tracking-tight sm:text-4xl">
            Теория
          </h1>
          <p className="mt-1.5 text-[11px] leading-tight text-muted sm:text-xs">
        ...
        <div
          className="gauge h-[76px] w-[76px] sm:h-[92px] sm:w-[92px]"
          style={
            {
        ...
        >
          ...
          <span aria-hidden className="flex flex-col items-center leading-none">
            ...
            >
              {started ? pct : "—"}
              {started ? <span className="text-[11px] sm:text-sm">%</span> : null}
            </span>
            <span className="mt-1 font-mono text-[8px] uppercase tracking-[0.14em] text-muted sm:text-[9px]">
              готовност
            </span>
          </span>
        </div>
      ...
      <div className="panel-inset mt-3 p-3 sm:mt-4 sm:p-4">
        <div className="flex items-center gap-2">
          <span
            aria-hidden
            className="flex h-6 w-6 shrink-0 items-center justify-center rounded-md bg-accent/15 text-accent ring-1 ring-accent/25"
          >
        ...
        <p className="mt-1.5 text-[13px] leading-snug text-foreground sm:text-sm sm:leading-relaxed">
          {focus.reason}
        </p>
        ...
        <div className="mt-3 flex flex-wrap gap-2">
          <Link
            ...
            className="btn-accent flex-1 px-4 py-2.5 text-[13px] sm:flex-none sm:px-6"
          >
            Умна тренировка
          </Link>
          {focus.topic ? (
