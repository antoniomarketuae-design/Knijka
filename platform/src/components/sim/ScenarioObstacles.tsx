...
// Re-exported so a scene caller still has ONE import for "the obstacle layer";
// the shapes themselves are owned by the sim module (audit M-19), because the
// recipe builder and the held-scenery tables author them and must not depend on
// a "use client" R3F file to know what they are building.
export type {
  ScenarioAnimalObstacle,
  ScenarioObstacleSpec,
  ScenarioPropKind,
